...
test('getContentAsString correctly gets content and translates from Base64 to utf-8', async () => {
    ...
    getContentMock.mockImplementationOnce(async () => {
        ...
        ;(contentResponse.data as any).content = Buffer.from('Hello World!', 'utf8').toString(
            'base64'
        )
    ...
    getContentMock
        ...
        .mockImplementationOnce(async () => {
            ...
            contentResponse.data = [
                generateGitHubSubDirectory('Q1'),
                generateGitHubSubDirectory('Q2')
            ]
            return contentResponse
        })
        .mockImplementationOnce(async () => {
        ...
        .mockImplementationOnce(async () => {
            // Q1/Problem.md
            const contentResponse = generateGetContentResponse()
            ;(contentResponse.data as any).content = Buffer.from('Task A', 'utf8').toString(
                'base64'
            )
            return contentResponse
        })
        .mockImplementationOnce(async () => {
            // Q1/StarterCode.js
            const contentResponse = generateGetContentResponse()
            ;(contentResponse.data as any).content = Buffer.from('Code A', 'utf8').toString(
                'base64'
            )
            return contentResponse
        })
        .mockImplementationOnce(async () => {
            // Q2/Problem.md
            const contentResponse = generateGetContentResponse()
            ;(contentResponse.data as any).content = Buffer.from('Task B', 'utf8').toString(
                'base64'
            )
            return contentResponse
        })
        .mockImplementationOnce(async () => {
            // Q2/StarterCode.js
            const contentResponse = generateGetContentResponse()
            ;(contentResponse.data as any).content = Buffer.from('Code B', 'utf8').toString(
                'base64'
            )
            return contentResponse
        })
...
test('convertIMCQQuestionToMCQText works properly', () => {
    ...
    expect(GitHubMissionDataUtils.convertIMCQQuestionToMCQText(inputMCQObject)).toEqual(
        expectedText
    )
})
