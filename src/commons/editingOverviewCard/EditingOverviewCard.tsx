        ...
        <div>
            <Card className="row listing" elevation={Elevation.ONE}>
                <div
                    ...
                    onClick={this.toggleEditField('coverImage')}
                >
                ...
                <div className="col-xs-9 listing-text">
                    ...
                    <div
                        className="row listing-description"
                        onClick={this.toggleEditField('shortSummary')}
                    >
                    ...
                    <div className="listing-controls">
                        <Text className="listing-due-date">
                            ...
                            <div
                                ...
                                onClick={this.toggleEditField('openAt')}
                            >
                            ...
                            <div
                                className="date-container"
                                onClick={this.toggleEditField('closeAt')}
                            >
