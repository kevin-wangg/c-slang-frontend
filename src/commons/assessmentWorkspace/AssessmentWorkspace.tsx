...
import { convertEditorTabStateToProps, NormalEditorContainerProps } from '../editor/EditorContainer'
...
const AssessmentWorkspace: React.FC<AssessmentWorkspaceProps> = props => {
            ...
            : [
                  ...
                  },
                  {
                      ...
                      body: (
                          <Markdown
                              className="sidecontent-overview"
                              content={props.assessment!.longSummary}
                          />
                      ),
                      id: SideContentType.briefing
                  },
                  {
                      ...
                      body: (
                          <SideContentAutograder
                              ...
                              handleTestcaseEval={id =>
                                  dispatch(evalTestcase(workspaceLocation, id))
                              }
    ...
    const controlBarProps: (q: number) => ControlBarProps = (questionId: number) => {
        const listingPath = `/courses/${props.courseId}/${assessmentTypeLink(
        ...
        const questionProgress: [number, number] = [
            questionId + 1,
            props.assessment!.questions.length
        ]
                ...
                if (question.type === QuestionTypes.mcq) {
                    ...
                    if (!isCorrect) {
                        return showWarningMessage(
                            'Your solution has not passed all testcases!',
                            750
                        )
                    }
                }
                ...
                <ButtonGroup>
                    ...
                    <ControlButton
                        ...
                        onClick={() => {
                            closeOverlay()
                            props.handleEditorValueChange(
                                (props.assessment!.questions[questionId] as IProgrammingQuestion)
                                    .solutionTemplate
                            )
                            props.handleUpdateHasUnsavedChanges(true)
                        }}
