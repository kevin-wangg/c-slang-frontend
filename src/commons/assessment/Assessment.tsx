...
const Assessment: React.FC<AssessmentProps> = props => {
        ...
        return (
            ...
            >
                <Button
                    ...
                    minimal={true}
                    onClick={() =>
                        props.handleAcknowledgeNotifications(
                            filterNotificationsByAssessment(overview.id)
                        )
                    }
                >
                        ...
                        <div className="listing-footer">
                            <div>
                                <Text className="listing-due-date">
                                    <Icon
                                        className="listing-due-icon"
                                        iconSize={12}
                                        icon={IconNames.CALENDAR}
                                    />
                                    {`${
                                        beforeNow(overview.openAt) ? 'Opened' : 'Opens'
    ...
    const assessmentOverviews = React.useMemo(
        () =>
            assessmentOverviewsUnfiltered?.filter(
                ao => ao.type === props.assessmentConfiguration.type
            ),
