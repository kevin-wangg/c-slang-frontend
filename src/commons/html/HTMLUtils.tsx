...
const DISCLAIMER_DIALOG_PROPS: SimpleConfirmDialogProps = {
    ...
    contents: (
        <p>
            You are about to access HTML code written by others, which may contain malicious
            scripts.
            <br />
            <br />
            This might pose a security concern if you are not careful and fully aware of what the
            shared HTML code contains!
            <br />
            <br />
