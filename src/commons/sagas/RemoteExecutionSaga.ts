...
import { ExceptionError } from 'wlp3/dist/errors/errors'
import { Variant } from 'wlp3/dist/types'
...
export function* remoteExecutionSaga(): SagaIterator {
    ...
    yield takeLatest(
        ...
        function* (action: ReturnType<typeof actions.remoteExecDisconnect>) {
            ...
            yield put(
                actions.externalLibrarySelect(ExternalLibraryName.NONE, session.workspace, true)
            )
        }
    )
