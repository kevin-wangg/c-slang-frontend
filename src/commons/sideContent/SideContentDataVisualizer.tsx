    ...
    public render() {
        ...
        configure({
            ignoreEventsCondition: event => {
                return (
                    (event.key === 'ArrowLeft' && firstStep()) ||
                    (event.key === 'ArrowRight' && finalStep())
                )
            },
