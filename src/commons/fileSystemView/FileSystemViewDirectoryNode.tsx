...
const FileSystemViewDirectoryNode: React.FC<FileSystemViewDirectoryNodeProps> = (
    ...
    const handleRemoveDirectory = () => {
        showSimpleConfirmDialog({
            ...
            contents: (
                <p>
                    This will result in all of its contained files & subdirectories being deleted.
                    Once a directory is deleted, its contents cannot be recovered!
                    <br />
                    <br />
        ...
        fileSystem.exists(newFilePath, newFilePathExists => {
            if (newFilePathExists) {
                showSimpleErrorDialog({
                    ...
                    contents: (
                        <p>
                            A file or folder <b>{fileName}</b> already exists in this location.
        ...
        fileSystem.exists(newDirectoryPath, newDirectoryPathExists => {
            if (newDirectoryPathExists) {
                showSimpleErrorDialog({
                    ...
                    contents: (
                        <p>
                            A file or folder <b>{subdirectoryName}</b> already exists in this
