...
const MobileWorkspace: React.FC<MobileWorkspaceProps> = props => {
    ...
    const createWorkspaceInput = () => {
        if (props.editorContainerProps) {
            ...
            return (
                <EditorContainer {...enableMobileKeyboardForEditor(props.editorContainerProps)} />
            )
        } else {
    ...
    const sideBarTabs: SideContentTab[] = props.sideBarProps.tabs.filter(
    ...
    return (
        <div className="workspace mobile-workspace">
            {props.hasUnsavedChanges ? (
                <Prompt
                    message={
                        'You have changes that may not be saved. Are you sure you want to leave?'
                    }
                />
            ) : null}
