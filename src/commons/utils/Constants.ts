...
const sicpBackendUrl = process.env.REACT_APP_SICPJS_BACKEND_URL || 'https://sicp.sourceacademy.org/'
...
const caFulfillmentLevel = isTest ? 24 : parseInt(process.env.REACT_APP_CA_FULFILLMENT_LEVEL || '0')

const authProviders: Map<string, { name: string; endpoint: string; isDefault: boolean }> = new Map()
