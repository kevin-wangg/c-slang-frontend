    ...
    const editableMetaDetails = (type: GoalType) => {
        switch (type) {
            case GoalType.ASSESSMENT:
                return (
                    <EditableAssessmentMeta
                        assessmentMeta={meta as AssessmentMeta}
                        changeMeta={changeMeta}
                    />
                )
            case GoalType.BINARY:
                return (
                    <EditableBinaryMeta binaryMeta={meta as BinaryMeta} changeMeta={changeMeta} />
                )
            case GoalType.MANUAL:
                return (
                    <EditableManualMeta changeMeta={changeMeta} manualMeta={meta as ManualMeta} />
                )
            case GoalType.EVENT:
