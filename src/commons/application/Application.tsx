                ...
                <div className="Application__main">
                    {isDisabledEffective && (
                        <Switch>
                            ...
                            <Route>
                                <Disabled
                                    reason={typeof isDisabled === 'string' ? isDisabled : undefined}
                                />
                            </Route>
                        </Switch>
                    )}
                    ...
                    {!isDisabledEffective && !Constants.playgroundOnly && (
                        <Switch>
                            ...
                            <Route
                                path="/welcome"
                                render={ensureUserAndRouteTo(props, <Welcome />)}
                            />
                            <Route
                    ...
                    <div className="research-prompt">
                        ...
                        >
                            <div className={Classes.DIALOG_BODY}>
                                ...
                                <div>
                                    Here at Source Academy @ NUS, our mission is to bring out the
                                    beauty and fun in programming and the ideas behind programming,
                                    and to make these ideas universally accessible. This includes
                                    educational research!
                                </div>
                                <br />
                                <div>
                                    We collect programs that students run in Source Academy @ NUS
                                    and store them anonymously for our research. You are free to opt
                                    out of this collection, with no penalty for you whatsoever.
                                    Contact your course instructor if you have questions or concerns
                                    about this research.
                                </div>
                            </div>
