...
export default class ObjectPlacement extends Phaser.Scene {
    ...
    public create() {
        ...
        this.closedBracket = this.input.keyboard.addKey(
    ...
    private populateCursorModes() {
        if (this.cursorModes) {
            ...
            this.cursorModes.addCursorMode(
                ...
                'Print coordinates',
                () =>
                    this.logManager.printCheckpoint(
                        this.backgroundManager.getBackgroundAssetPath(),
                        [this.objectManager, this.bboxManager]
                    ),
                () =>
            ...
            this.cursorModes.addCursorMode(
                ...
                () => {
                    ...
                    if (!confirm) return
                    this.getLayerManager().clearSeveralLayers([
                        Layer.Background,
                        Layer.BBox,
                        Layer.Objects
                    ])
