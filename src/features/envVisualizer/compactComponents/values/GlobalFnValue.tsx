...
import { Circle, Group, Label as KonvaLabel, Tag as KonvaTag, Text as KonvaText } from 'react-konva'
...
export class GlobalFnValue extends Value implements IHoverable {
    ...
    constructor(
        ...
        if (mainReference instanceof Binding) {
            this._x =
                mainReference.frame.x() +
                mainReference.frame.width() +
                CompactConfig.FrameMarginX / 4
            ...
            if (mainReference.isLastUnit) {
                ...
                this._y =
                    mainReference.y() + mainReference.parent.height() + CompactConfig.DataUnitHeight
            }
    ...
    updatePosition(): void {
        const mainReference =
            this.referencedBy.find(x => x instanceof Binding) || this.referencedBy[0]
        if (mainReference instanceof Binding) {
            this._x =
                mainReference.frame.x() +
                mainReference.frame.width() +
