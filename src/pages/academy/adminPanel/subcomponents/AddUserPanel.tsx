        ...
        for (let i = 0; i < data.length; i++) {
            ...
            if (!(data[i].length === 2 || data[i].length === 3)) {
                setInvalidCsvMsg(
                    <>
                        <div>
                            Invalid format (line {i})! Please ensure that the username and role is
                            specified for each row entry!
                        </div>
                        <br />
                        <div>
                                            ...
                                            content={
                                                <div>
                                                    ...
                                                    <p>
                                                        ...
                                                        : the username of the learner in the
                                                    ...
                                                    <p>
                                                        ...
                                                        : the group name that the learner belongs to
                                                        in this course
                                                    </p>
                                                    <p>
                                                        <i>
                                                            (*Note that staff or admin will
                                                            automatically be assigned as group
                                                            leader and each group
                                                        </i>
                                                    </p>
                                                    <p>
                                                        <i>
                                                            can only have one leader. If there are
                                                            duplicates the latest entry will take
                                                            effect)
                                                        </i>
                                                    </p>
                            ...
                            label={
                                <div className="html-select-label">
                                    ...
                                    >
                                        <Icon
                                            icon={IconNames.HELP}
                                            className="html-select-label-icon"
                                        />
                                    </Popover2>
                                </div>
                            }
