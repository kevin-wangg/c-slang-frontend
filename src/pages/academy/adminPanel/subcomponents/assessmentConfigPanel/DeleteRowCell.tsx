        ...
        <>
            ...
            >
                <div className={Classes.DIALOG_BODY}>
                    <p>
                        Are you sure you want to <b>delete</b> the assessment type{' '}
                        <i>{props.data.type}</i>?
                    </p>
                    <p>
                        <b>
                            All related assessments, submissions and answers will be deleted as well
                            upon clicking the main save button.
                        </b>
                    </p>
                </div>
