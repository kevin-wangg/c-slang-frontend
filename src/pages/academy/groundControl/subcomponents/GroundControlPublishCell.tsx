        ...
        <>
            ...
            >
                <div className={Classes.DIALOG_BODY}>
                    <p>
                        Are you sure you want to <b>{isPublished ? 'unpublish' : 'publish'}</b> the
                        assessment <i>{data.title}</i>?
                    </p>
                    {isPublished ? (
                        <p>
                            <b>
                                This will hide the assessment for students and prevent them from
                                uploading new answers. Admins and staff are not affected.
                            </b>
                        </p>
                    ) : null}
                </div>
