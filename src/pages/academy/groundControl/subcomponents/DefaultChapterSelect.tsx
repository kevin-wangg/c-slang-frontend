    ...
    const dialog = (
        ...
        >
            <div className={Classes.DIALOG_BODY}>
                Are you sure you want to update the <b>default Playground Source sublanguage</b>{' '}
                from {styliseSublanguage(sourceChapter, sourceVariant)} to{' '}
                <b>{chosenSublang.displayName}</b>?
            </div>
