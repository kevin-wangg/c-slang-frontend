    ...
    public render() {
        ...
        const RecorderPauseButton = (
            <ControlButton
                ...
                onClick={this.handleRecorderPausing}
            />
        )
        const RecorderResumeButton = (
            <ControlButton
                label="Resume"
                icon={IconNames.PLAY}
                onClick={this.handleRecorderResuming}
            />
        )
        ...
        const RecorderStartButton = (
            <ControlButton
                label="Record"
                icon={IconNames.PLAY}
                onClick={this.handleRecorderStarting}
            />
        )
        const RecorderStopButton = (
            <ControlButton
                label="Stop"
                icon={IconNames.STOP}
                onClick={this.handleRecorderStopping}
            />
        )
        ...
        return (
            <div>
                ...
                <div className="RecorderControl">
                    {this.props.recordingStatus === RecordingStatus.notStarted &&
                        RecorderStartButton}
                    {this.props.recordingStatus === RecordingStatus.paused && RecorderResumeButton}
                    {this.props.recordingStatus === RecordingStatus.paused &&
                        RecorderResumeFromCurrentButton}
                    {this.props.recordingStatus === RecordingStatus.recording &&
                        RecorderPauseButton}
                    {this.props.recordingStatus === RecordingStatus.recording &&
                        RecorderRecordPauseButton}
