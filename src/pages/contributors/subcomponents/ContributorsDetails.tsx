    ...
    <div className="outsideDetails">
        <Card className="contributorsDetails" elevation={Elevation.ONE}>
            ...
            <p className="description">
                The <i>Source Academy</i> is designed and developed by a team of students, most of
                who have used the system to learn the fundamentals of computing and enjoyed it. This
                page includes all developers who contributed to the Source Academy <i>Merlin</i>{' '}
                (2023) and its precursors <i>Rook</i> (2022), <i>Knight</i> (2020) and <i>Cadet</i>{' '}
                (2018). These versions succeeded Source Academy 2 (2017) and ultimately the original
                Source Academy (2016).
            </p>
            ...
            <div className="hallOfFame">
                ...
                <p>
                    Julius Putra Tanu Setiaji {dot} Lee Ning Yuan {dot} Vignesh Shankar {dot} Thomas
                    Tan {dot} Chen Shaowei
                </p>
                <p>
            ...
            <div className="contributors">
                ...
                <p>
                    ...
                    <a href={Links.githubOrg}>GitHub repositories of the Source Academy</a>. Feel
                    free to join us!
                </p>
            </div>
        </Card>
